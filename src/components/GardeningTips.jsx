...
const gardeningTips = [
  {
    ...
    details:
      "Avoid watering the leaves to prevent fungal growth and always use deep watering to encourage strong roots.",
    image:
      "https://ideogram.ai/assets/progressive-image/balanced/response/uBUZ7jNtTbuPXoyz1MuI9A",
  },
  {
    id: 2,
    ...
    details:
      "Add organic compost to enrich the soil and maintain a balanced pH level. Consider mulching to retain moisture.",
    image:
...
const recommendedTools = [
  {
    ...
    image:
      "https://ideogram.ai/assets/image/lossless/response/woGiiwlrRhiFoYYqplspXw",
  },
  {
    name: "Watering Can",
