  ...
  const plants = [
    {
      ...
      multimedia: [
        ...
        "/images/tulsi3.png",
        "/images/tulsi4.png",
        "https://www.youtube.com/embed/HL6XdPLgoGA?si=8GJlm-Yw92GGSohg",
      ],
      name: "Tulsi",
      region: "Tropical",
      type: "Herb",
      habitat: "Tropical, Subtropical",
      botname: "Ocimum tenuiflorum",
      comnames: "Tulsi, Holy Basil",
      meduses: "Immunity booster, Respiratory disorders",
      methofcul: "Seed Propagation, Full Sunlight",
      description:
        "Tulsi, also known as holy basil, is a revered plant in Ayurveda known for its healing properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/3272493ccf6c4ede895f259905ef1db8/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "/images/neem3.png",
        "/images/neem4.png",
        "https://www.youtube.com/embed/fA-l1t_Aotw?si=oc1PFJNyG7iFARLx",
      ],
      name: "Neem",
      region: "Tropical",
      type: "Tree",
      habitat: "Tropical, Subtropical",
      botname: "Azadirachta indica",
      comnames: "Neem, Indian Lilac",
      meduses: "Antibacterial, Antifungal",
      methofcul: "Seeds, Saplings",
      description:
        "Neem is a fast-growing tree used in traditional medicine for its antibacterial properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/03edef8009d942d3a3db6fa64cecbe56/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/7NqgGS1_zmE?si=9WEnCcRm58nCJoSy",
      ],
      name: "Aloe Vera",
      region: "Tropical",
      type: "Succulent",
      habitat: "Ayurveda",
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/66c6699e50ab4863989777f920a981dd/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/8Oxw4BgqQ2Y?si=MVyTAJ43oFLRvUza",
      ],
      name: "Lavender",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/08f35ae30b924678955b4bb483b86a70/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "/images/sage3.png",
        "/images/sage4.png",
        "https://www.youtube.com/embed/aaKJm9jad6Q?si=fcqs8MYzl1HTKTAi",
      ],
      name: "Sage",
      region: "Temperate",
      type: "Herb",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/f41f028de9ca4be2b2e85df0820508ae/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "/images/cactus3.png",
        "/images/cactus4.png",
        "https://www.youtube.com/embed/Uds_rPbFkpU?si=Z5pkrP2xGsrmN1G9",
      ],
      name: "Cactus",
      region: "Arid",
      type: "Succulent",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/01d773057954447a9abb7ae0c6c052af/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/T6pjGwkK2po?si=ar7M8GDjw34P89hu",
      ],
      name: "Dandelion",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/8a93f08947a4499b9ed19d2d47323242/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/N8xcQRCSKbQ?si=xxaP0Y4XMRM4sVXP",
      ],
      name: "Eucalyptus",
      region: "Temperate",
      type: "Tree",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/d021e7909df44e03b976c1374bfab9dc/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "/images/hibiscus2.png",
        "/images/hibiscus2.png",
        "https://www.youtube.com/embed/4W44xiXvUAI?si=T-hBaOKpbJ32CCpe",
      ],
      name: "Hibiscus",
      region: "Tropical",
      type: "Flowering Plant",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/8992b6b94b094a069930104a32d5e9f5/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/GrnrDsGao20?si=SOGnrcs5UROhX536",
      ],
      name: "Rosemary",
      region: "Mediterranean",
      type: "Herb",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/d5c0f249ff8a4d13840abf681bb92d29/embed?autospin=1&autostart=1",
      audioSrc: "/audio/rosemery.mp3",
    },
    {
      ...
      multimedia: [
        ...
        "https://www.youtube.com/embed/OE14JsyuEII?si=mqgjr9iTqhlU9kOU",
      ],
      name: "Ashwagandha",
      region: "Arid",
      type: "Shrub",
      habitat: "Dry Regions, India, Africa",
      botname: "Withania Somnifera",
      comnames: "Ashwagandha, Indian Ginseng",
      meduses: "Stress Relief, Immunity Boost",
      methofcul: "Sandy Soil, Full Sun",
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/88b1bf03a6254dc2b56cec4dce3f22f1/embed?autospin=1&autostart=1",
    ...
    },
    {
      ...
      multimedia: [
        ...
        "/images/ginger3.png",
        "/images/ginger4.png",
        "https://www.youtube.com/embed/uniaqvtHVhw?si=5ooLbhjODICnEbX2",
      ],
      name: "Ginger",
      region: "Tropical",
      type: "Herb",
      ...
      description:
        "Ashwagandha is a powerful herb in Ayurveda, known for its stress-relieving properties.",
      sketchfabModelUrl:
        "https://sketchfab.com/models/de8da99c3c1742708cd4ea858750b881/embed?autospin=1&autostart=1",
      audioSrc: "/audio/ginger.mp3",
    },
  ];
